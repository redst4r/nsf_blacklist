"""blacklisted words from the report
...
blacklist_dict = {
    "gender": gender_words,
    "social_justice": social_justice_words,
    "status": status_words,
    "race": race_words,
...
def load_blacklist():
    """load a dict of the NSF-blacklisted terms"""
    def _proc_term(term):
        return term.strip()

    return toolz.valmap(lambda x: [_proc_term(_) for _ in x], blacklist_dict)
